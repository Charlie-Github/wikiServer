...
// http://upload.wikimedia.org/wikipedia/commons/1/10/Arch_of_SeptimiusSeverus.jpg

foreach ($imageUrls as &$value) {
    echo "<img style=\"-webkit-user-select: none; cursor: -webkit-zoom-in;\" src=\"$value\" width=\"378\" height=\"284\">";
}
